...
function DoctorRegister() {
  ...
  return (
    <div className={`min-h-screen flex ${dark ? 'bg-gray-900' : 'bg-white'}`}>
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            {[
              ...
              <div
                key={s.label}
                className="bg-white bg-opacity-15 rounded-2xl p-4"
              >
      ...
      {/* Right Panel */}
      <div
        className={`w-full lg:w-1/2 flex items-center justify-center px-6 py-12 relative overflow-y-auto ${
      ...
      >
        ...
        <div className="w-full max-w-md">
          ...
          <p className="text-gray-400 text-sm mb-8">
            Join our verified doctor network
          </p>
              ...
              <div className="flex flex-col gap-4">
                ...
                <div>
                  ...
                  <input
                    type="text"
                    name="doctorId"
                    placeholder="Enter hospital-issued Doctor ID"
                  ...
                  >
                    Enter the Doctor ID provided by your hospital authority.
                  </p>
                </div>
