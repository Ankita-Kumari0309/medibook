...
function Skeleton({ className }) {
  return (
    <div
      className={`animate-pulse bg-blue-50 rounded-xl ${className}`}
    />
  );
}
  ...
  return (
    <div className="flex items-center gap-3 p-3 bg-red-50 border border-red-100 rounded-xl text-sm text-red-600">
      ...
      {onRetry && (
        <button
          onClick={onRetry}
          className="flex items-center gap-1 text-xs font-semibold hover:text-red-700"
        >
          <MdRefresh size={14} />
          Retry
        </button>
...
function StatCard({
  ...
  return (
    <div
      className={`relative bg-white rounded-2xl p-5 border border-gray-100 shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden group ring-1 ${ring} hover:ring-2`}
    >
      <div
        className={`absolute -top-6 -right-6 w-24 h-24 rounded-full bg-gradient-to-br ${gradient} opacity-[0.07] group-hover:opacity-[0.13] transition-opacity duration-300`}
      />

      <div className="flex items-start justify-between mb-4">
        <div
          className={`w-10 h-10 rounded-xl ${light} flex items-center justify-center`}
        >
          <Icon
            size={19}
            className={accent}
      ...
      <div
        className={`text-[11px] mt-0.5 font-semibold ${accent} opacity-70`}
      >
        {deltaLabel}
      </div>
    </div>
...
function HeaderBanner({
  ...
  return (
    ...
    >
      ...
      <svg
        className="absolute right-0 top-0 h-full w-64 opacity-10"
        viewBox="0 0 200 80"
      ...
      <div className="relative flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3 flex-shrink-0">
          <div className="bg-white/15 backdrop-blur-sm border border-white/20 rounded-xl px-5 py-3 text-center">
            ...
            <div className="text-blue-100 text-[11px] font-medium mt-0.5">
              Status
            </div>
          </div>
...
function QueueRow({
  ...
  return (
    ...
    >
      ...
      <div
        className={`flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[11px] font-semibold ${badge.bg} ${badge.color}`}
      >
        <span
    ...
    <div className="flex items-center gap-3 p-3 bg-amber-50 border border-amber-100 rounded-xl hover:shadow-md transition-all duration-200">
      ...
      <div className="flex gap-1.5 flex-shrink-0">
        <button
          ...
          className="px-2.5 py-1.5 rounded-lg bg-blue-500 text-white text-[11px] font-semibold hover:bg-blue-600 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
        >
          {isUpdating
            ? "..."
            : "Accept"}
        ...
        <button
          ...
          className="px-2.5 py-1.5 rounded-lg bg-white border border-gray-200 text-gray-500 text-[11px] font-semibold hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
        >
          {isUpdating
            ? "..."
            : "Decline"}
...
export default function DoctorOverview({
  ...
  const [loadingDash, setLoadingDash] =
    useState(true);
