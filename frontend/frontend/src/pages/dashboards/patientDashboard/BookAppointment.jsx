...
function BookingModal({ doctor, onClose }) {
  ...
  // Fetch doctor availability when modal opens
  useEffect(() => {
  ...
  const fetchSlotsForDate = async (selectedDate) => {
    ...
    try {
      ...
      const { data } = await API.get(
        `/doctor/availability/${doctor._id}?date=${selectedDate}`
      );
  ...
  const slotsForDate = () => {
    ...
    if (Array.isArray(availability.selectedDateSlots)) {
      return availability.selectedDateSlots;
    }
      ...
      <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
        <div className="bg-white rounded-3xl p-6 w-full max-w-md text-center shadow-2xl">
          ...
          <div className="mt-4 text-sm text-gray-600 space-y-2 text-left bg-teal-50 p-4 rounded-xl">
            ...
            <p>
              <b>Speciality:</b>{" "}
              {availability.doctor.speciality}
            </p>
            ...
            <p>
              <b>Fee:</b>{" "}
              ₹{availability.doctor.fees}
            </p>

            {availability.doctor.experience && (
              <p>
                <b>Experience:</b>{" "}
                {availability.doctor.experience}+ yrs
              </p>
            )}
    ...
    <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50">
      ...
      <div className="bg-white/90 backdrop-blur-xl rounded-3xl p-6 w-full max-w-lg shadow-2xl">
        ...
        <div className="flex flex-wrap gap-2 mb-3 min-h-[40px]">
          ...
          {date && slotsLoading && (
            <div className="flex items-center gap-2 text-gray-400 text-xs self-center">
